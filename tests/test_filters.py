...
from ripe.atlas.tools.filters import FilterFactory, Filter, ASNFilter, filter_results
...
class TestFilter(unittest.TestCase):
    def test_filter(self):
        ...
        sagan_result.probe = Probe(
            id=1216, meta_data={"country_code": "GR", "asn_v4": 3337, "asn_v6": "4445"}
        )
...
class TestFilterResults(unittest.TestCase):
    def setUp(self):
        ...
        probes = [
            ...
            Probe(
                id=12, meta_data={"country_code": "DE", "asn_v4": 3339, "asn_v6": 3337}
            ),
            Probe(
                id=1, meta_data={"country_code": "NL", "asn_v4": 3337, "asn_v6": "4446"}
            ),
        ]
        self.sagan_results = []
        for probe in probes:
    ...
    def test_filter_results1(self):
        ...
        expected_results = [
            self.sagan_results[0],
            self.sagan_results[2],
            self.sagan_results[3],
        ]
        filters = [
            FilterFactory.create("asn", 3337),
            FilterFactory.create("country_code", "NL"),
        ]
        self.assertEqual(filter_results(filters, self.sagan_results), expected_results)
