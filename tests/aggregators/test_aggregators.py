...
class TestAggregators(unittest.TestCase):
    ...
    def test_mixed_aggregation(self):
        ...
        keys = [
            RangeKeyAggregator(ranges=[1, 5, 10, 20, 30, 35], key="rtt"),
    ...
    def test_mixed_aggregation1(self):
        ...
        keys = [
            RangeKeyAggregator(ranges=[10, 200], key="rtt"),
            ValueKeyAggregator(key="probe.country"),
            ValueKeyAggregator(key="probe.status"),
        ]
        buckets = aggregate(self.results, keys)
        expected_output = {
            "RTT: 10-200": {
