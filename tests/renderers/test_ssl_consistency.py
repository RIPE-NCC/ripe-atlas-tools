...
class TestSSLConsistency(unittest.TestCase):
        ...
        cls.results = [
            {
                u"rt": 737.834,
                u"msm_id": 1443369,
                u"from": u"210.6.135.152",
                u"dst_name": u"torproject.org",
                u"af": 4,
                u"timestamp": 1392727294,
                u"fw": 4570,
                u"cert": [
                ...
                u"prb_id": 1003,
                u"dst_port": u"443",
                u"dst_addr": u"86.59.30.40",
                u"ttc": 355.078,
                u"src_addr": u"192.168.1.182",
                u"group_id": 1443369,
                u"type": u"sslcert",
                u"msm_name": u"SSLCert",
                u"ver": u"3.0",
            },
            {
                u"rt": 496.488,
                u"msm_id": 1443369,
                u"from": u"218.254.74.122",
                u"dst_name": u"torproject.org",
                u"af": 4,
                u"timestamp": 1392727295,
                u"fw": 4570,
                u"cert": [
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                ...
                u"prb_id": 1004,
                u"dst_port": u"443",
                u"dst_addr": u"38.229.72.14",
                u"ttc": 239.37,
                u"src_addr": u"192.168.1.100",
                u"group_id": 1443369,
                u"type": u"sslcert",
                u"msm_name": u"SSLCert",
                u"ver": u"3.0",
            ...
            {
                u"from": u"183.62.4.188",
                u"dst_name": u"torproject.org",
                u"err": u"connect: timeout",
                u"fw": 4600,
                u"timestamp": 1392727294,
                u"af": 4,
                u"dst_addr": u"216.234.179.13",
                u"prb_id": 1008,
                u"dst_port": u"443",
                u"group_id": 1443369,
                u"type": u"sslcert",
            ...
            },
            {
                u"rt": 658.671,
                u"msm_id": 1443369,
                u"from": u"113.255.77.244",
                u"dst_name": u"torproject.org",
                u"af": 4,
                u"timestamp": 1392727293,
                u"fw": 4570,
                u"cert": [
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                ...
                u"prb_id": 1033,
                u"dst_port": u"443",
                u"dst_addr": u"82.195.75.101",
                u"ttc": 324.6,
                u"src_addr": u"192.168.0.183",
                u"group_id": 1443369,
                u"type": u"sslcert",
                u"msm_name": u"SSLCert",
                u"ver": u"3.0",
            ...
            },
            {
                ...
                u"prb_id": 1047,
                u"dst_port": u"443",
                u"dst_addr": u"93.95.227.222",
                u"ttc": 302.403,
                u"src_addr": u"192.168.6.137",
                u"group_id": 1443369,
                u"type": u"sslcert",
                u"msm_name": u"SSLCert",
                u"ver": u"3.0",
            ...
            {
                u"from": u"116.237.191.131",
                u"dst_name": u"torproject.org",
                u"err": u"connect: timeout",
                u"fw": 4600,
                u"timestamp": 1392727292,
                u"af": 4,
                u"dst_addr": u"209.145.54.50",
                u"prb_id": 11572,
                u"dst_port": u"443",
                u"group_id": 1443369,
                u"type": u"sslcert",
            ...
            {
                u"from": u"116.247.110.182",
                u"dst_name": u"torproject.org",
                u"err": u"connect: timeout",
                u"fw": 4580,
                u"timestamp": 1392727294,
                u"af": 4,
                u"dst_addr": u"202.181.7.85",
                u"prb_id": 11700,
                u"dst_port": u"443",
                u"group_id": 1443369,
                u"type": u"sslcert",
            ...
            },
            {
                u"rt": 768.923,
                u"msm_id": 1443369,
                u"from": u"103.15.180.250",
                u"dst_name": u"torproject.org",
                u"af": 4,
                u"timestamp": 1392727296,
                u"fw": 4580,
                u"cert": [
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
            ...
            {
                u"dnserr": u"non-recoverable failure in name resolution (1)",
                u"from": u"103.6.129.113",
                u"dst_name": u"torproject.org",
                u"fw": 4580,
                u"timestamp": 1392727293,
                u"prb_id": 12214,
            ...
            },
            {
                u"rt": 471.564,
                u"msm_id": 1443369,
                u"from": u"103.247.138.60",
                u"dst_name": u"torproject.org",
                u"af": 4,
                u"timestamp": 1392727304,
                u"fw": 4600,
                u"cert": [
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                    u"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----",  # noqa: E501
                ...
                u"prb_id": 1386,
                u"dst_port": u"443",
                u"dst_addr": u"38.229.72.16",
                u"ttc": 228.561,
                u"src_addr": u"103.247.138.60",
                u"group_id": 1443369,
                u"type": u"sslcert",
                u"msm_name": u"SSLCert",
                u"ver": u"3.0",
            ...
            {
                u"from": u"210.22.91.254",
                u"dst_name": u"torproject.org",
                u"err": u"connect: timeout",
                u"fw": 4570,
                u"timestamp": 1392727297,
                u"af": 4,
                u"dst_addr": u"4.36.66.178",
                u"prb_id": 3386,
                u"dst_port": u"443",
                u"group_id": 1443369,
                u"type": u"sslcert",
    ...
    def test_gather_unique_certs(self):
        ...
        expected_certs = {
            "1A:B8:9E:ED:1B:DD:A0:E2:EA:67:89:C1:C5:4B:20:1C:49:9D:74:27:B0:5D:11:F2:9A:5F:C1:0D:F9:18:48:DA": {  # noqa: E501
                "cnt": 1,
                "probes": [self.probes[2844]],
            },
            "36:13:D2:B2:2A:75:00:94:76:0C:41:AD:19:DB:52:A4:F0:5B:DE:A8:01:72:E2:57:87:61:AD:96:7F:7E:D9:AA": {  # noqa: E501
                "cnt": 11,
                "probes": [
                    self.probes[1003],
                    self.probes[1004],
            ...
            "21:EB:37:AB:4C:F6:EF:89:65:EC:17:66:40:9C:A7:6B:8B:2E:03:F2:D1:A3:88:DF:73:42:08:E8:6D:EE:E6:79": {  # noqa: E501
                "cnt": 11,
                "probes": [
                    self.probes[1003],
                    self.probes[1004],
            ...
            "07:52:BE:65:72:BF:02:D4:C9:E2:93:09:A8:E0:BE:3A:EA:D4:30:41:B8:49:FA:C5:F2:12:33:07:37:57:EE:C7": {  # noqa: E501
                "cnt": 1,
                "probes": [self.probes[2844]],
            },
        }
