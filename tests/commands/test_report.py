...
class TestReportCommand(unittest.TestCase):
    ...
    mocked_results = [
        {
            "af": 4,
            "prb_id": 1216,
            "result": [{"rtt": 27.429}, {"rtt": 25.672}, {"rtt": 25.681}],
            "ttl": 54,
            "avg": 26.2606666667,
            "size": 20,
            "from": "109.190.83.40",
        ...
        },
        {
            "af": 4,
            "prb_id": 165,
            "result": [{"rtt": 87.824658}, {"rtt": 87.611154}, {"rtt": 90.99957}],
            "ttl": 48,
            "avg": 88.811794,
            "size": 20,
            "from": "194.85.27.7",
            "proto": "ICMP",
            "timestamp": 1445025590,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 202,
            "result": [{"rtt": 40.02356}, {"rtt": 40.399112}, {"rtt": 39.29012}],
            "ttl": 52,
            "avg": 39.904264,
            "size": 20,
            "from": "178.190.51.206",
            "proto": "ICMP",
            "timestamp": 1445015502,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 270,
            "result": [{"rtt": 28.527366}, {"rtt": 26.585862}, {"rtt": 26.393094}],
            "ttl": 51,
            "avg": 27.168774,
            "size": 20,
            "from": "188.192.110.111",
            "proto": "ICMP",
            "timestamp": 1445025513,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 579,
            "result": [{"rtt": 23.201285}, {"rtt": 22.980868}, {"rtt": 22.863364}],
            "ttl": 51,
            "avg": 23.0151723333,
            "size": 20,
            "from": "195.88.195.170",
            "proto": "ICMP",
            "timestamp": 1445025521,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 677,
            "result": [{"rtt": 40.71476}, {"rtt": 40.258568}, {"rtt": 40.316936}],
            "ttl": 54,
            "avg": 40.430088,
            "size": 20,
            "from": "78.128.9.202",
            "proto": "ICMP",
            "timestamp": 1445025298,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 879,
            "result": [{"rtt": 34.319623}, {"rtt": 34.445575}, {"rtt": 34.376455}],
            "ttl": 53,
            "avg": 34.380551,
            "size": 20,
            "from": "94.254.125.2",
            "proto": "ICMP",
            "timestamp": 1445025223,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
        ...
        },
        {
            "af": 4,
            "prb_id": 945,
            "result": [{"rtt": 61.665036}, {"rtt": 23.833349}, {"rtt": 23.268868}],
            "ttl": 56,
            "avg": 36.255751,
            "size": 20,
            "from": "92.111.237.94",
            "proto": "ICMP",
            "timestamp": 1445025494,
            "dup": 0,
            "type": "ping",
            "sent": 3,
            "msm_id": 1000192,
    ...
    def test_arg_from_file(self):
        ...
        try:
            temp_file.write(json.dumps(self.mocked_results).encode("utf-8"))
            temp_file.close()
        ...
        with capture_sys_output() as (stdout, stderr):
            ...
            with mock.patch(path) as mock_get:
                ...
                with mock.patch(mpath) as mock_get_many:
                    ...
                    self.cmd.run()
                    self.assertEqual(stdout.getvalue(), self.expected_output_no_aggr)
    ...
    def test_asns_filter(self):
        ...
        probes = [
            ...
            Probe(
                id=165,
                meta_data={"country_code": "NL", "asn_v4": 3334, "asn_v6": "4444"},
            ),
            Probe(
                id=1216,
                meta_data={"country_code": "GR", "asn_v4": 3335, "asn_v6": "4444"},
            ),
            Probe(
                id=270,
                meta_data={"country_code": "GR", "asn_v4": 3340, "asn_v6": "4444"},
            ),
            Probe(
                id=579,
                meta_data={"country_code": "GR", "asn_v4": 3336, "asn_v6": "4444"},
            ),
            Probe(
                id=945,
                meta_data={"country_code": "GR", "asn_v4": 3334, "asn_v6": "4444"},
            ),
            Probe(
                id=879,
                meta_data={"country_code": "GR", "asn_v4": 3333, "asn_v6": "4444"},
